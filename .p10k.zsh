# Generated by Powerlevel10k configuration wizard on 2022-08-30 at 03:56 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_STATUS_OK=true   #false
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR=true     #default=false
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='✘'
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=7     #default=3 コマンドミスの文字色
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=160   #default=1 コマンドミスの背景色
  ...
  typeset -g POWERLEVEL9K_BATTERY_BACKGROUND=23     #default=0 バッテリー背景色 他の色にするなら0
